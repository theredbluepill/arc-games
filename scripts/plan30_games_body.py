# Auto-built specs for plan30_write_remaining.py — each: stem, title, desc, tags, grid_range, action_space, py_source
# noqa: file is data + embedded Python sources
...
# --- rn01 rope between adjacent anchors (two ACTION6 clicks) ---
_add(
    "rn01",
    "Rope Anchors",
    "Click two orth-adjacent anchor posts (ACTION6) to place a walkable rope cell between them over water.",
    ["static", "planning", "click"],
    [12, 12],
    6,
    r'''"""Plan #4: rope segment between adjacent anchors via two ACTION6 clicks."""
