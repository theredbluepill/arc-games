...
SECTION_12_MARKDOWN = dedent(
    ...
    - Patterns in **[AGENTS.md](https://github.com/theredbluepill/arc-interactive/blob/main/AGENTS.md)** and skills under **[`skills/`](https://github.com/theredbluepill/arc-interactive/tree/main/skills)**.
