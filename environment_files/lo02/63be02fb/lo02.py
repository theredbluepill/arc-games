...
levels = [
    ...
    # 3–5: forward-generated under torus+orthogonal toggles (see devtools/solvers/torus_lights_gf2.py).
    mk(
        [(0, 0), (0, 1), (0, 3), (1, 0), (1, 2), (2, 3), (3, 1), (3, 3), (4, 1)],
        [],
        (5, 5),
        3,
    ),
    ...
    mk(
        [(0, 4), (0, 5), (1, 5), (2, 0), (2, 4), (2, 5), (4, 0), (5, 0), (5, 3), (5, 5)],
        [],
        (6, 6),
        5,
    ),
