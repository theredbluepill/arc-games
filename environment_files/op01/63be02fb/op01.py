...
levels = [
    mk((8, 8), (1, 1), (3, 2), (5, 2), [], 1),
    mk((8, 8), (1, 3), (3, 3), (6, 3), [(4, y) for y in range(8) if y != 3], 2),
    mk((10, 10), (1, 1), (2, 4), (7, 7), [(5, y) for y in range(10) if y not in (4, 5)], 3),
    mk((8, 8), (0, 2), (2, 2), (6, 2), [(4, y) for y in range(8) if y != 2], 4),
    mk((8, 8), (1, 1), (4, 4), (6, 6), [], 5),
]
