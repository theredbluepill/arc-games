"""Sand columns: tan sand piles fall one cell after each move when supported from below."""
...
levels = [
    ...
    mk(
        [
            ...
            sprites["sand"].clone().set_position(4, 3),
            sprites["sand"].clone().set_position(5, 3),
        ],
        2,
    ),
    mk(
    ...
    mk(
        [
            ...
            sprites["sand"].clone().set_position(5, 1),
        ],
        4,
    ),
    mk(
