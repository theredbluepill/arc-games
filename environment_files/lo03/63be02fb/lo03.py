...
levels = [
    ...
    # 3–5: forward-generated under torus+king toggles (see devtools/solvers/torus_lights_gf2.py).
    mk(
        [(0, 1), (0, 2), (0, 3), (2, 0), (2, 1), (2, 2), (4, 0), (4, 1), (4, 2)],
        [],
        (5, 5),
        3,
    ),
    mk(
        [(0, 0), (0, 2), (2, 2), (2, 4), (3, 1), (3, 2), (3, 3), (3, 4), (4, 1)],
        [],
        (5, 5),
        4,
    ),
